...
WriteLiteral("\r\n");
 ...
 using (var sc = Html.TypeContext<EmailConfigurationDN>()) 
{
...
Write(Html.ValueLine(sc, ca => ca.UrlLeft));
            ...
            #line 10 "..\..\Mailing\Views\EmailConfiguration.cshtml"
Write(Html.ValueLine(sc, ca => ca.CreationDateHoursLimitToSendEmails));
...
Write(Html.ValueLine(sc, ca => ca.MaxEmailSendRetries));
